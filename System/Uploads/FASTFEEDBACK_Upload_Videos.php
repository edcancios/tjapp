...
if (isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $path = "Midia/Videos/"; //set your folder path
    //set the valid file extensions 
    $valid_formats = array("mp4", "ogg", "WebM", "MP4", "OGG"); //add the formats you want to upload
    ...
    if (strlen($name)) { //check if the file is selected or cancelled after pressing the browse button.
        ...
        if (in_array($ext, $valid_formats)) { //if the file is valid go on.
            ...
            echo "Tipo de arquivo inválido! Apenas arquivos de vídeo podem ser utilizados!";
        }
    } else {
        echo "Tamanho do arquivo excedido! Máximo de 2mb!";
    }
    exit;
}else{
    echo "Tamanho do arquivo excedido! Máximo de 2mb!";
